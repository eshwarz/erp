					...
					for ($k=0;$k<count($auctionRecord);$k++)
					{
						...
						<tr class="hidden_link border" id="result_lot_<?php echo $currentAuction; ?>">
							...
							<td class="last">
								...
								<a href="#" class="edit_lot hide mr5" id="" onclick="ajaxpage('view/weights/edit_weight.php?id=<?php echo $currentAuction; ?>','lb_content'); open_lb('popup','popup_panel'); return false;">Edit</a>
							</td>
						</tr>
						<?php
					}

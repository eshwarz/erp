			...
			for ($i=0;$i<count($records);$i++)
			{
				...
				<tr class="hidden_link print_all_borders" id="result_lot_<?php echo $records[$i]['lot_id']; ?>">
					...
					<td class="last dontPrint">
						...
						<a href="#" class="edit_lot hide mr5" id="" onclick="open_lb('popup','popup_panel', true, function(){ ajaxpage('view/weights/edit_weight.php?id=<?php echo $records[$i]['lot_id']; ?>','lb_content'); }); return false;">Edit</a>
					</td>
				</tr>
				<?php
			}

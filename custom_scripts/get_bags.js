$(document).ready(function(){
	$(".lotNumber").live("keyup",function(){
		...
		if (multiple_buyers == 1)
		{
			...
			document.getElementById("weightListPost").setAttribute("onclick","ajaxPost('weight_list/weight_list_q.php','farmer_new,village,farmer,quality,buyer,cost,lotNumber,serialNumber"+bags+buyers+"','result');this.form.reset();document.getElementById('farmer').focus();return false;");
		}
		else
		{

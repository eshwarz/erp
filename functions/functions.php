...
{
	$fields;
	$get_fields = mysqli_query("SHOW FIELDS FROM ".$table);
...
function get_farmers_with_ids ()
{
	...
	$get_farmers_result = mysqli_query($get_farmers);
...
function get_buyers_with_ids ()
{
	...
	$get_buyers_result = mysqli_query($get_buyers);
...
function get_qualities_with_ids ()
{
	...
	$get_quality_result = mysqli_query($get_quality);
...
function get_villages_with_ids ()
{
	...
	$get_village_result = mysqli_query($get_village);

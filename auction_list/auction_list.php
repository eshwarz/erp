...
<div class="wa bce brd_b">
    <div class="wa p10 cf tc bbg">Auction List</div>
    <div id="result"></div>
    <div class="pt20 pb20">
        <form>
            <?php
        	...
        	<div id="newFarmerModule" class="dn">
                <div class="sideHeader">
                    ...
                    <div class="pr fr">
                        <div class="fl">
                            <input type="text" value="Farmer's name" id="farmer_new" onfocus="unfill(this.id,'Farmer\'s name');" onblur="fill(this.id,'Farmer\'s name');" style="width:152px;-moz-border-radius:0px;-webkit-border-radius:0px;"/>
                        </div>
            ...
            <div class="sideHeader mt5">
                ...
                <div class="fr">
                    <input type="text" value="Lot Number" id="lotNumber" class="" onfocus="unfill(this.id,'Lot Number');" onblur="fill(this.id,'Lot Number');" />
                </div>
                <div class="cbo"></div>
            </div>
            ...
            <div class="sideHeader mt5" style="background-color:transparent;">
                ...
                <div class="fr">
                    ...
                    {
                        ?>
                    	<input type="submit" class="button" value="Save" id="weightListPost" onclick="ajaxPost('auction_list/auction_list_q.php','farmer_new,village,farmer,quality,buyer,cost,lotNumber,serialNumber','result');this.form.reset();return false;" />
                        <?php
                    }
                    else
                    {
                        ?>
                        <input type="submit" class="button" value="Save" id="weightListPost" onclick="ajaxPost('auction_list/auction_list_q.php','farmer_new,village,farmer,quality,buyer,cost,lotNumber','result');this.form.reset();return false;" />
                        <?php
                    }
                    ?>
                </div>

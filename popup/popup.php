<div id="popup">
	...
	<div id="popup_panel" class="">
    	<div id="lb_close" class="pa fb cp lh30 pr5 c3" onclick="close_lb('popup','popup_panel','lb_loader','lb_content');">&nbsp;X&nbsp;</div>
    	<div id="popup_inner_panel" class="">
        	<div class="">
